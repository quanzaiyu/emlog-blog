...
<div class="row" id="detailDownload">
    <div class="col-lg-12">
        <table class="table">
            <tbody>
                <tr>
                    <th style="width:10%;"><label>资源名称</label></th>
                    <th><input type="text" class="form-control" name="name" id="name" value="<?php echo $logData['name']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>资源大小</label></th>
                    <th><input type="text" class="form-control" name="size" id="size" value="<?php echo $logData['size']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>更新时间</label></th>
                    <th><input type="text" class="form-control" name="up_date" id="up_date" value="<?php echo $logData['up_date']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>适用版本</label></th>
                ...
                <tr>
                    <th style="width:10%;"><label>作者来源</label></th>
                    <th><input type="text" class="form-control" name="dauthor" id="dauthor" value="<?php echo $logData['author']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>演示地址</label></th>
                    <th><input type="text" class="form-control" name="yanshi" id="yanshi" value="<?php echo $logData['yanshi']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>百度网盘</label></th>
                    <th><input type="text" class="form-control" name="baidudown" id="baidudown" value="<?php echo $logData['baidudown']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>百度网盘密码</label></th>
                    <th><input type="text" class="form-control" name="baidumima" id="baidumima" value="<?php echo $logData['baidumima']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>迅雷快传</label></th>
                    <th><input type="text" class="form-control" name="xunlei" id="xunlei" value="<?php echo $logData['xunlei']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>360网盘</label></th>
                    <th><input type="text" class="form-control" name="tszwp" id="tszwp" value="<?php echo $logData['tszwp']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>360网盘密码</label></th>
                    <th><input type="text" class="form-control" name="tszwpmima" id="tszwpmima" value="<?php echo $logData['tszwpmima']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>其他网盘</label></th>
                    <th><input type="text" class="form-control" name="other" id="other" value="<?php echo $logData['other']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>官方下载</label></th>
                    <th><input type="text" class="form-control" name="web" id="web" value="<?php echo $logData['web']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>城通网盘</label></th>
                    <th><input type="text" class="form-control" name="ctldown" id="ctldown" value="<?php echo $logData['ctldown']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
                <tr>
                    <th style="width:10%;"><label>普通下载</label></th>
                    <th><input type="text" class="form-control" name="general" id="general" value="<?php echo $logData['general']; ?>" size="30" tabindex="30" style="width: 80%;"></th>
                </tr>
            </tbody>
        </table>
    </div>
...
<script>
    function showOrHide(){
        if($("#openDownload .switch").children('input').prop('checked')){
            $("#openDownload").siblings('#detailDownload').show('fast');
        }else{
            $("#openDownload").siblings('#detailDownload').hide('fast');
        }
    }
    $(function(){
        showOrHide();
        $("#openDownload .switch").click(function(event) {
            showOrHide();
        });
    });
</script>
