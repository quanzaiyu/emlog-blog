...
function widget_blogger($title){
  ...
  <div id="zhanzhang_wenzi"><b>站长：</b><?php echo $name; ?><br>
    <b style="float: left;">签名：</b>
      <div style="float: left;"><?php echo $user_cache[1]['des']; ?></div>
    </div>
...
function blog_navi(){
  ...
  foreach($navi_cache as $value):
    ...
    <li class="item <?php echo $current_tab;?>">
      <a href="<?php echo $value['url']; ?>" <?php echo $newtab;?> class="chaffle_none" data-lang="zh"><?php echo $value['naviname']; ?></a>
      <?php if (!empty($value['children'])) :?>
      <ul class="sub-nav animated flipInY">
        <?php foreach ($value['children'] as $row){
                echo '<li><a href="'.Url::sort($row['sid']).'" class="chaffle_none" data-lang="zh">'.$row['sortname'].'</a></li>';
        }?>
      </ul>
      <?php endif;?>
      ...
      <ul class="sub-nav animated flipInY">
          <?php foreach ($value['childnavi'] as $row){
                  ...
                  echo '<li><a class="chaffle_none" data-lang="zh" href="' . $row['url'] . "\" $newtab >" . $row['naviname'].'</a></li>';
          }?>
      </ul>
      <?php endif;?>
  ...
  <?php endforeach; ?>
    ...
    <li class="item common">
      <a href="<?php echo rand_log(); ?>" class="shake shake-little hint--top hint--error" data-hint="今日手气好，没事乱翻书。">碰碰手气</a>
    </li>
    <?php endif; ?>
  </ul>
<?php }?>
...
function index_t($num){
  ...
  ?>
  <div id="gonggao">
     <div id="ggwz"><a href="<?php echo BLOG_URL; ?>/t"><?php echo $row['content'];?></a></div>
     <div id="gonggao_img"><img src="<?php echo TEMPLATE_URL; ?>images/gonggao.png"></div>
    </div>
  <div id="gonggao_bk">
     <div class="ggwz2"><img src="<?php echo TEMPLATE_URL; ?>images/gonggao_xlb.gif"> <b>最新说说：</b><a href="<?php echo BLOG_URL; ?>/t"><?php echo $row['content'];?></a></div>
   </div>
  <?php }?>
<?php } ?>
