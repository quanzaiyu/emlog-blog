...
function widget_blogger($title){
	...
	<li>
	<h3 class="catListTitle"><?php echo $title; ?></h3>
	<div class="newsItem">
...
function widget_newcomm($title){
	...
	?>
	<li id="comment"><a href="<?php echo $url; ?>"><?php echo $value['content']; ?></a><p>——<?php echo $value['name']; ?></p></li>
	<?php endforeach; ?>
	</ul>
	</li>
<?php }?>
...
function neighbor_log($neighborLog){
	extract($neighborLog);?>
	<?php if($prevLog):?>
	博主上一篇：<a href="<?php echo Url::log($prevLog['gid']) ?>">«<?php echo $prevLog['title'];?></a>
	<?php endif;?>
	<?php if($nextLog && $prevLog):?>
		<br>
	<?php endif;?>
	<?php if($nextLog):?>
	博主下一篇：<a href="<?php echo Url::log($nextLog['gid']) ?>">»<?php echo $nextLog['title'];?></a>
	<?php endif;?>
<?php }?>
<?php
//blog：引用通告
