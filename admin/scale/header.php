          ...
          <div class="col-xs-4">
            <div class="padder-v">
              <a href="comment.php">
                ...
                <small class="text-muted">评论管理</small>
              </a>
            </div>
          </div>
          <div class="col-xs-4">
          ...
          <div class="col-xs-4">
            <div class="padder-v">
              <a href="../map.html" target="_blank">
                ...
                <small class="text-muted">网站地图</small>
              </a>
            </div>
          </div>
          <div class="col-xs-4">
            <div class="padder-v">
              <a href="../">
                ...
                <small class="text-muted">我的博客</small>
              </a>
            </div>
          </div>
          <div class="col-xs-4">
            <div class="padder-v">
              <a href="blogger.php">
                ...
                <small class="text-muted">后台设置</small>
              </a>
            </div>
          </div>
          <div class="col-xs-4">
            <div class="padder-v">
              <a href="http://www.youngxj.cn/tools/">
                <span class="m-b-xs block"><i class="i i-clock i-2x text-warning-lter"></i></span>
                <small class="text-muted">工具箱</small>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railopacity="0.2">
          ...
          <nav class="nav-primary hidden-xs">
            <ul class="nav nav-main" data-ride="collapse">
              <li id="menu_home"><a href="./" class="auto"><i class="i i-home icon"></i><span class="font-bold">后台主页</span></a></li>
