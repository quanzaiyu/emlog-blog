					...
					<div class="col-md-2 col-sm-4">
						<div class="panel b-a">
							<div class="panel-heading no-border bg-info lt text-center">
								<a href="./tag.php"><i class="fa fa-tags fa fa-3x m-t m-b text-white"></i></a>
							</div>
							<div class="padder-v text-center clearfix">
								<div class="col-xs-12 b-r">
									<div class="h3 font-bold">标签管理</div>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-2 col-sm-4">
						<div class="panel b-a">
							<div class="panel-heading no-border bg-success lt text-center">
								<a href="./user.php"><i class="fa fa-user fa fa-3x m-t m-b text-white"></i></a>
							</div>
							<div class="padder-v text-center clearfix">
								<div class="col-xs-12 b-r">
									<div class="h3 font-bold">用户管理</div>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-2 col-sm-4">
						<div class="panel b-a">
							<div class="panel-heading no-border bg-danger lt text-center">
								<a href="./data.php"><i class="i i-data fa fa-3x m-t m-b text-white"></i></a>
							</div>
							<div class="padder-v text-center clearfix">
								<div class="col-xs-12 b-r">
									<div class="h3 font-bold">数据管理</div>
								</div>
							</div>
						</div>
					</div>
